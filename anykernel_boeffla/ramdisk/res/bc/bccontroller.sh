...
KERNEL_SPECS="oneplus5t;oos;oos4xx;http://kernel.boeffla.de/oneplus5t/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS4xx-OnePlus5T-anykernel.recovery.zip"
